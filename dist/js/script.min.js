"use strict";function testWebP(e){var t=new Image;t.onload=t.onerror=function(){e(2==t.height)},t.src="data:image/webp;base64,UklGRjoAAABXRUJQVlA4IC4AAACyAgCdASoCAAIALmk0mk0iIiIiIgBoSygABc6WWgAA/veff/0PP8bA//LwYAAA"}function displayHint(e){document.querySelector(".hint__"+e).style.display="block"}function hideHint(e){document.querySelector(".hint__"+e).style.display="none"}function soundPlay(e){gameSetting.sound}function setSoundControlBar(){let e=void 0;sessionStorage.getItem("volume")&&(e=100*sessionStorage.getItem("volume")),0===e&&(e+=.01),soundControlBar.value=e||50,Howler.volume((.01*soundControlBar.value).toFixed(2)),console.log(Howler._volume)}function getBooleanDataFromSessionStorage(e,t=!1){switch(sessionStorage.getItem(e)){case"false":return!1;case"true":return!0;default:return t}}function random(e,t){return e=Math.ceil(e),t=Math.floor(t),Math.floor(Math.random()*(t-e+1))+e}function removeStartBtn(){startBtn.y>=document.documentElement.clientHeight||!startBtn?startBtn.remove():(startBtn.y+=player.speed,startBtn.style.top=startBtn.y+"px",requestAnimationFrame(removeStartBtn))}testWebP((function(e){1==e?document.querySelector("body").classList.add("webp"):document.querySelector("body").classList.add("no-webp")})),
/*!
 *  howler.js v2.2.1
 *  howlerjs.com
 *
